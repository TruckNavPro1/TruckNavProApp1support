-- =====================================================
-- TruckNavPro - POI Database Schema (Clean Install)
-- =====================================================
-- This version drops existing objects first
-- =====================================================
...
-- NOTE: Do NOT drop update_updated_at_column() - it's shared with other tables
...
-- NOTE: update_updated_at_column() function already exists and is shared with other tables
-- We'll use it for our triggers but NOT recreate it
